    ...
    <div class="col-lg-5 d-flex flex-column gap-2">
      <UiCard padding="3" class="d-flex flex-column gap-3">
        <div>
          ...
          <UiSelectButtons
            v-model="carConfigStore.selectedVersion"
            :options="versions"
          />
        </div>
        ...
        <div>
          ...
          <UiColorPicker
            v-model="carConfigStore.selectedColor"
            :options="colors"
          />
        </div>
        ...
        <div>
          ...
          <UiToggleButtons
            v-model="carConfigStore.selectedAddons"
            :options="addons"
          />
        </div>
        ...
        <div>
          ...
          <p class="fw-bold text-primary fs-lg">
            {{ maskNumber(carConfigStore.totalPrice) }} zł
          </p>
        </div>

        <UiButton
          class="bg-third text-white btn-lg w-100"
          @click="carConfigStore.submitConfig"
      ...
      <UiCard padding="3">
        ...
        <template v-if="carConfigStore.selectedVersionDetails">
          ...
          <UiInfoRow
            title="Ładowanie"
            :content="carConfigStore.selectedVersionDetails.charging"
          />
          <UiInfoRow
          ...
          <UiInfoRow
            title="Gwarancja"
            :content="carConfigStore.selectedVersionDetails.warranty"
          />
        </template>
      </UiCard>
    </div>
